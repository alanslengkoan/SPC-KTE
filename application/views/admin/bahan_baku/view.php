            ...
            <div class="page-body">
                <div class="card">
                    ...
                    <div class="card-block table-border-style">
                        <table class="table table-striped table-bordered nowrap" id="tabel-bahan-baku" style="width: 100%;">
                        </table>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="modal-add-upd" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="form-add-upd" action="<?= admin_url() ?>bahan_baku/process_save" method="POST">
                <!-- begin:: id -->
                <input type="hidden" name="inpidbahanbaku" id="inpidbahanbaku" />
                <!-- end:: id -->
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="inpkdbahanbaku" id="inpkdbahanbaku" placeholder="Masukkan kode bahan baku" readonly="readonly" />
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" name="inpidsatuan" id="inpidsatuan">
                                <option value="">- Pilih Satuan -</option>
                                <?php foreach ($satuan->result() as $key => $row) { ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" name="inpidjenis" id="inpidjenis">
                                ...
                                <?php foreach ($jenis->result() as $key => $row) { ?>
