...
<div class="modal fade" id="modal-add-upd" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="form-add-upd" action="<?= admin_url() ?>stok_barang/process_save" method="POST">
                <div class="modal-body">
                    ...
                    <!-- begin:: untuk detail komposisi -->
                    <div id="detail-komposisi"></div>
                    <!-- end:: untuk detail komposisi -->
                </div>
