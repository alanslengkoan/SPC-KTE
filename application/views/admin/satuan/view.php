            ...
            <div class="page-body">
                <div class="card">
                    ...
                    <div class="card-block table-border-style">
                        <table class="table table-striped table-bordered nowrap" id="tabel-satuan" style="width: 100%;">
                        </table>
                    </div>
                </div>
            </div>
            ...
            <form id="form-add-upd" action="<?= admin_url() ?>satuan/process_save" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="inpkdsatuan" id="inpkdsatuan" placeholder="Masukkan kode satuan" readonly="readonly" />
                        </div>
                    </div>
                    <div class="form-group row">
