            ...
            <div class="page-body">
                <div class="card">
                    ...
                    <div class="card-block table-border-style">
                        <table class="table table-striped table-bordered nowrap" id="tabel-distribusi" style="width: 100%;">
                        </table>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="modal-add-upd" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="form-add-upd" action="<?= admin_url() ?>distribusi/process_save" method="POST">
                <!-- begin:: id -->
                <input type="hidden" name="inpiddistribusi" id="inpiddistribusi" />
                <input type="hidden" name="inpidusers" id="inpidusers" />
                <!-- end:: id -->

                <div class="modal-body">
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Kode Distribusi *</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="inpkddistribusi" id="inpkddistribusi" placeholder="Masukkan kode distribusi" readonly="readonly" />
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="inpnpwp" id="inpnpwp" placeholder="Masukkan npwp" />
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" pattern="\d*" maxlength="12" minlength="12" name="inptelepon" id="inptelepon" placeholder="Masukkan telepon" />
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" pattern="\d*" maxlength="5" minlength="5" name="inpkdpos" id="inpkdpos" placeholder="Masukkan kode pos" />
                        </div>
                    </div>
                    <div class="form-group row">
