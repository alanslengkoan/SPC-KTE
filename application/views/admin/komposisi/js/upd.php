...
<script>
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        <div class="button-icon-btn button-icon-btn-cl">
                            <button type="button" id="btn-upd" data-id="` + full.id_komposisi_detail + `" class="btn btn-info btn-sm waves-effect" data-toggle="modal" data-target="#modal-add-upd"><i class="fa fa-pencil"></i>&nbsp;Ubah</button>&nbsp;
                            <button type="button" id="btn-del" data-id="` + full.id_komposisi_detail + `" class="btn btn-warning btn-sm waves-effect"><i class="fa fa-trash"></i>&nbsp;Hapus</button>
                        </div>
                    `;
                    },
                },
    ...
    var untukGetIdData = function() {
        $(document).on('click', '#btn-upd', function() {
            ...
            $.ajax({
                type: "POST",
                url: "<?= admin_url() ?>komposisi/get_det",
                dataType: 'json',
                data: {
                    id: ini.data('id')
                },
                ...
                success: function(response) {
                    $('#inpidkomposisidetail').val(response.id_komposisi_detail);
        ...
        $(document).on('click', '#btn-del', function() {
            ...
            swal({
                ...
                if (del) {
                    $.ajax({
                        type: "post",
                        url: "<?= admin_url() ?>komposisi/process_del_det",
                        dataType: 'json',
                        data: {
                            id: ini.data('id')
                        },
