        ...
        <div class="page-wrapper">
            <div class="page-body">
                <form id="form-add-upd-head" action="<?= admin_url() ?>komposisi/process_save" method="POST">
                    <!-- begin:: id -->
                    <input type="hidden" name="inpidkomposisi" id="inpidkomposisi" />
                    <!-- end:: id -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-block table-border-style">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" name="inpkdbarang" id="inpkdbarang">
                                        ...
                                        <?php foreach ($barang->result() as $key => $row) { ?>
                                            <option value="<?= $row->kd_barang ?>"><?= $row->nama ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="inpstokbarang" id="inpstokbarang" placeholder="Masukkan jumlah produksi" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-block table-border-style">
                            <table class="table table-striped table-bordered nowrap" id="tabel-temp-komposisi" style="width: 100%;"></table>
                            <hr>
...
<div class="modal fade" id="modal-add-upd" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="form-add-upd" action="<?= admin_url() ?>komposisi/process_save_temp" method="POST">
                <!-- begin:: id -->
                <input type="hidden" name="inpidtkomposisi" id="inpidtkomposisi" />
                <!-- end:: id -->
