        ...
        <div class="page-wrapper">
            <div class="page-body">
                <form id="form-add-upd" action="<?= admin_url() ?>pembayaran/process_save" method="POST">
                    <!-- begin:: id -->
                    <input type="hidden" name="inpidpembelian" id="inpidpembelian" value="<?= $pembelian->id_pembelian ?>" readonly="readonly" />
                    <!-- end:: id -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-block table-border-style">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="inpnotransaksi" id="inpnotransaksi" placeholder="" value="<?= $pembelian->no_transaksi ?>" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Jenis Transaksi</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="inpjenistransaksi" id="inpjenistransaksi" placeholder="" value="Pembelian" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Supplier</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="<?= $pembelian->nama ?>" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Jumlah Stok</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="<?= $pembelian->jumlah_stok ?>" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="inptotalbayar" id="inptotalbayar" value="<?= create_separator($total_akhir) ?>" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group row">
