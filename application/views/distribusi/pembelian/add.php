...
<div class="pcoded-inner-content">
    <div class="main-body">
        <div class="page-wrapper">
            <div class="page-body">
                <form id="form-add-upd-head" action="<?= distribusi_url() ?>pembelian/process_save" method="POST">
                    <!-- begin:: form 1 -->
                    <div class="card">
...
<div class="modal fade" id="modal-add-upd" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="form-add-upd" action="<?= distribusi_url() ?>pembelian/process_save_temp" method="POST">
                <!-- begin:: id -->
                <input type="hidden" name="inpidtpenjualan" id="inpidtpenjualan" />
                <!-- end:: id -->
                ...
                <div class="modal-body">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" name="inpkdbarang" id="inpkdbarang">
                                ...
                                <?php foreach ($barang->result() as $key => $row) { ?>
                                    <option value="<?= $row->kd_barang ?>">(<?= $row->kd_barang ?>) - <?= $row->nama ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="inpstokproduksi" id="inpstokproduksi" value="0" placeholder="0" readonly="readonly" />
                        </div>
                    </div>
                    <div class="form-group row">
