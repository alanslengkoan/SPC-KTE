...
<head>
    <title>Sistem Informasi Supply Chain - <?= $title ?> | <?= get_users_detail($this->session->userdata('id'))->nama ?></title>
    <meta charset="utf-8">
...
<body>
    ...
    <div id="pcoded" class="pcoded">
        ...
        <div class="pcoded-container navbar-wrapper">
            <!-- begin:: navbar -->
            <?php $this->load->view('distribusi/layouts/navbar'); ?>
            <!-- end:: navbar -->

            <div class="pcoded-main-container">
                <div class="pcoded-wrapper">
                    <!-- begin:: sidebar -->
                    <?php $this->load->view('distribusi/layouts/sidebar'); ?>
                    <!-- end:: sidebar -->
