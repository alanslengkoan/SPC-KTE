            ...
            <div class="page-body">
                <div class="card">
                    ...
                    <div class="card-block table-border-style">
                        <table class="table table-striped table-bordered nowrap" id="tabel-stok-barang" style="width: 100%;">
                        </table>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="modal-add-upd" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="form-add-upd" action="<?= distribusi_url() ?>keluar/process_save" method="POST">
                <!-- begin:: id -->
                <input type="hidden" name="inpiddistribusi" id="inpiddistribusi" value="<?= $id_distribusi ?>" />
                <!-- end:: id -->
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="inpstok" id="inpstok" placeholder="Stok" readonly="readonly" />
                        </div>
                    </div>
                    <div class="form-group row">
