                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active show" id="foto" role="tabpanel">
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        <form id="form-foto" action="<?= supplier_url() ?>profil/upd_foto" method="POST">
                                            <div class="row">
                            ...
                            <div class="tab-pane" id="akun" role="tabpanel">
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        <form id="form-akun" action="<?= supplier_url() ?>profil/upd_akun" method="POST">
                            ...
                            <div class="tab-pane" id="keamanan" role="tabpanel">
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        <form id="form-keamanan" action="<?= supplier_url() ?>profil/upd_keamanan" method="POST">
                                            <div class="form-group row">
